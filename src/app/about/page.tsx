...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "quannnd2004@gmail.com",
    href: "mailto:quannnd2004@gmail.com",
  ...
  {
    name: "LinkedIn",
    href: "www.linkedin.com/in/alexanderphan04",
    content: "/Quân Phan",
    icon: <FaLinkedin height={"50px"} />,
  },
  {
    name: "GitHub",
    href: "https://github.com/AlexanderPhan04",
    content: "/Phan Nhật Quân",
          ...
          >
            <div className="flex flex-row lg:flex-col items-center">
              ...
              <div className="flex flex-col gap-3 lg:items-center ml-10 md:ml-20 lg:ml-0">
                <p className="text-center text-xl">Alexander Phan</p>
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10 text-roboto">
              Hey there! I&apos;m Alexander, a Fullstack developer passionate about
